class BadgeService {
  static List<Map<String, dynamic>> checkBadges(int xp, int streak, int prayerMinutes, {int todosCompleted = 0, int unifiedStreak = 0}) {
    ...
    if (unifiedStreak >= 14) earned.add(_badge('fortnight_faithful', 'Fortnight Faithful', '🕊️', '14-day streak — "Draw near to God" (James 4:8)'));
