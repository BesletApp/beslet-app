...
class $PrayerRoomsTable extends PrayerRooms
    with TableInfo<$PrayerRoomsTable, PrayerRoom> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $PrayerRoomsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  late final GeneratedColumn<String> lastEnteredAt = GeneratedColumn<String>(
    'last_entered_at',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'prayer_rooms';
  @override
  VerificationContext validateIntegrity(
    Insertable<PrayerRoom> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PrayerRoom map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PrayerRoom(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $PrayerRoomsTable createAlias(String alias) {
    return $PrayerRoomsTable(attachedDatabase, alias);
  }
}

class PrayerRoom extends DataClass implements Insertable<PrayerRoom> {
  final String id;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || lastEnteredAt != null) {
      map['last_entered_at'] = Variable<String>(lastEnteredAt);
    }
    return map;
  }

  PrayerRoomsCompanion toCompanion(bool nullToAbsent) {
    return PrayerRoomsCompanion(
      id: Value(id),
      name: Value(name),
      group: Value(group),
      sortOrder: Value(sortOrder),
  ...
  factory PrayerRoom.fromJson(
    ...
    return PrayerRoom(
      ...
      sortOrder: serializer.fromJson<int>(json['sortOrder']),
      createdAt: serializer.fromJson<String>(json['createdAt']),
      lastEnteredAt: serializer.fromJson<String?>(json['lastEnteredAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'sortOrder': serializer.toJson<int>(sortOrder),
      'createdAt': serializer.toJson<String>(createdAt),
      'lastEnteredAt': serializer.toJson<String?>(lastEnteredAt),
    };
  }
  ...
  PrayerRoom copyWith({
    ...
    int? sortOrder,
    String? createdAt,
    Value<String?> lastEnteredAt = const Value.absent(),
  }) => PrayerRoom(
    id: id ?? this.id,
    name: name ?? this.name,
  ...
  PrayerRoom copyWithCompanion(PrayerRoomsCompanion data) {
    return PrayerRoom(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('PrayerRoom(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('group: $group, ')
          ..write('sortOrder: $sortOrder, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, group, sortOrder, createdAt, lastEnteredAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PrayerRoom &&
...
class PrayerRoomsCompanion extends UpdateCompanion<PrayerRoom> {
  final Value<String> id;
  final Value<String> name;
  final Value<String> group;
  final Value<int> sortOrder;
  final Value<String> createdAt;
  final Value<String?> lastEnteredAt;
  final Value<int> rowid;
  const PrayerRoomsCompanion({
    this.id = const Value.absent(),
    this.name = const Value.absent(),
  ...
  PrayerRoomsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       name = Value(name),
       createdAt = Value(createdAt);
  static Insertable<PrayerRoom> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<String>? group,
    Expression<int>? sortOrder,
    Expression<String>? createdAt,
    Expression<String>? lastEnteredAt,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  PrayerRoomsCompanion copyWith({
    Value<String>? id,
    Value<String>? name,
    Value<String>? group,
    Value<int>? sortOrder,
    Value<String>? createdAt,
    Value<String?>? lastEnteredAt,
    Value<int>? rowid,
  }) {
    return PrayerRoomsCompanion(
      id: id ?? this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (lastEnteredAt.present) {
      map['last_entered_at'] = Variable<String>(lastEnteredAt.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('PrayerRoomsCompanion(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('group: $group, ')
          ..write('sortOrder: $sortOrder, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $PrayerRoomsTable prayerRooms = $PrayerRoomsTable(this);
  @override
...
typedef $$VerseChallengesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$PrayerRoomsTableCreateCompanionBuilder =
    PrayerRoomsCompanion Function({
      required String id,
      required String name,
      Value<String> group,
      Value<int> sortOrder,
...
typedef $$PrayerRoomsTableUpdateCompanionBuilder =
    PrayerRoomsCompanion Function({
      Value<String> id,
      Value<String> name,
      Value<String> group,
...
class $$PrayerRoomsTableFilterComposer
    extends Composer<_$AppDatabase, $PrayerRoomsTable> {
  $$PrayerRoomsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get lastEnteredAt => $composableBuilder(
    column: $table.lastEnteredAt,
    builder: (column) => ColumnFilters(column),
  );
}

class $$PrayerRoomsTableOrderingComposer
    extends Composer<_$AppDatabase, $PrayerRoomsTable> {
  $$PrayerRoomsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get lastEnteredAt => $composableBuilder(
    column: $table.lastEnteredAt,
    builder: (column) => ColumnOrderings(column),
  );
}

class $$PrayerRoomsTableAnnotationComposer
    extends Composer<_$AppDatabase, $PrayerRoomsTable> {
  $$PrayerRoomsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get lastEnteredAt => $composableBuilder(
    column: $table.lastEnteredAt,
    builder: (column) => column,
  );
}

class $$PrayerRoomsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $PrayerRoomsTable,
          ...
          $$PrayerRoomsTableOrderingComposer,
          $$PrayerRoomsTableAnnotationComposer,
          $$PrayerRoomsTableCreateCompanionBuilder,
          $$PrayerRoomsTableUpdateCompanionBuilder,
          (
            PrayerRoom,
            BaseReferences<_$AppDatabase, $PrayerRoomsTable, PrayerRoom>,
          ),
          PrayerRoom,
          PrefetchHooks Function()
        > {
  $$PrayerRoomsTableTableManager(_$AppDatabase db, $PrayerRoomsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$PrayerRoomsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$PrayerRoomsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$PrayerRoomsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> name = const Value.absent(),
...
typedef $$PrayerRoomsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $PrayerRoomsTable,
      PrayerRoom,
...
class $AppDatabaseManager {
  ...
  $$PrayerRoomsTableTableManager get prayerRooms =>
      $$PrayerRoomsTableTableManager(_db, _db.prayerRooms);
}
